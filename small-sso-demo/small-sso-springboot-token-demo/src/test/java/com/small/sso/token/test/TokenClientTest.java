package com.small.sso.token.test;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.small.sso.core.domain.SmallSsoConf;
import com.small.sso.token.test.util.HttpClientUtil;
 ...
 * @title
 * @description
 * @createDate 1/6/20 3:59 PM
 */
public class TokenClientTest {

    private static Logger logger = LoggerFactory.getLogger(TokenClientTest.class);

    public static String ssoServer = "http://smallssoserver.com:8080/small-sso-server";

    public static String client01 = "http://smallssoclient1.com:8082/small-sso-token-sample-springboot/";
    public static String client02 = "http://smallssoclient2.com:8082/small-sso-token-sample-springboot/";
    ...
    private void clientApiRequestTest(String clientApiUrl, String sessionId) throws IOException {
        ...
        headerParam.put(SmallSsoConf.SSO_SESSIONID, sessionId);
